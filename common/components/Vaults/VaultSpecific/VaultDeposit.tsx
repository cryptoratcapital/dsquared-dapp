...
import { useTokenApproval, useTokenBalance } from "@/common/utils/queries"
...
const VaultDeposit = () => {
  ...
  return (
    ...
    //       ) : (
    //         <p className={clsx(!correctChain && "hidden")}>{balance} USDC</p>
    //       )}
    //     </div>
    ...
    <div className="lg:col-span-4 border-[0.5px] border-dsqgreen-100 p-8 flex flex-col">
      ...
      <div className="flex items-center justify-between px-8 py-5 mt-10 mb-2 text-center border border-dsqgray-100 disabled cursor-not-allowed">
        <div className="flex gap-x-7">
          <div
            className={clsx(
              "px-2 py-1 text-sm border rounded-sm w-fit border-dsqgray-100 text-dsqgray-100 font-roboto-mono",
          ...
          >
            <p className="disabled cursor-not-allowed">MAX</p>
          </div>
          <Input
            variant="unstyled"
            placeholder="0"
      ...
      <div className="flex flex-col mt-4 gap-y-2">
        <div className="flex justify-between text-sm text-dsqgray-100">
          ...
          {balanceLoadedFail && correctChain ? (
            ...
            <p className={"hidden"}>{balance} USDC</p>
          )}
        </div>
